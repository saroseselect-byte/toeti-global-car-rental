...
function shellWith(shell,main,css){return shell.replace(/<main(?:\s[^>]*)?>[\s\S]*?<\/main>/,main).replace('</style>',`${css}</style>`).replace('href="/destination/zanzibar">Explore','href="/explore">Explore');}
