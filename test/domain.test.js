...
test('state machine allows only controlled transitions',()=>{ assert.equal(canTransition('REQUESTED','AWAITING_SUPPLIER'),true); assert.equal(canTransition('REQUESTED','CONFIRMED'),false); });
